...
const getProgressColorClass = (progress: number) => {
  ...
  switch (sectionName) {
    ...
    case "contactSection":
      return (
        <>
          <h2 className="cv-miami__contactSection--title">
    ...
    case "personalInfoSection":
      return (
        <>
          <h2 className="cv-miami__personalInfoSection--title">
    ...
    case "skillSection":
      return (
        <>
          <h2 className="cv-miami__skillSection--title">
    ...
    case "languageSection":
      return (
        <>
          <h2 className="cv-miami__languajeSection--title">
    ...
    case "linkSection":
      return (
        <>
          <h2 className="cv-miami__linkSection--title" >
    ...
    case "hobbieSection":
      return (
        <>
          <h2 className="cv-miami__hobbieSection--title" >
    ...
    case "profileSection":
      return (
        <>
          <h2 className="cv-miami__profileSection--title" >
    ...
    case "experienceSection":
      return (
        <>
          <h2 className="cv-miami__experienceSection--title" >
    ...
    case "educationSection":
      return (
        <>
          <h2 className="cv-miami__educationSection--title" >
    ...
    case "courseSection":
      return (
        <>
          <h2 className="cv-miami__courseSection--title" >
    ...
    case "awardSection":
      return (
        <>
          <h2 className="cv-miami__awardSection--title" >
    ...
    case "referenceSection":
      return (
        <>
          <h2 className="cv-miami__referenceSection--title" >
    ...
    case "customSection":
      return (
        <>
          <h2 className="cv-miami__customSection--title" >
