...
import "./cvriosectionsrender.scss"
...
import { cvRioDefaults } from "../CvRio";
...
export const CvRioSectionsRender: React.FC<SectionRenderProps> = ({
  sectionName,
  data,
  sectionByName,
}) => {
...
const getProgressColorClass = (progress: number) => {
  ...
  switch (sectionName) {
    ...
    case "identitySection":
      return (
        <>
          <div className="cv-rio__identitySection--main">
          {!previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false &&
          typeof section?.progress === "number" && (
            <span
              className={`progress-indicator cv-rio__identitySection--progress-indicator ${getProgressColorClass(
                section.progress
              )}`}
            >
              {section.progress}%
              <TbArrowBadgeRight className="cv-rio__arrow" />
            </span>
          )}
            ...
            {sectionByName[sectionName]?.title || "Contacto"}
            {
              !previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false && <span className={`progress-indicator ${getProgressColorClass(section.progress)}`}>
                ...
                <TbTrashX onClick={(e) => {
                  ...
                  }} className="cv-rio__remove" />
              </span>
            }
          </h2>
              {contactSection.map((item) => (
                <div key={item.id} className="cv-rio__contactSection--item">
                  <h3 className="cv-rio__contactSection--item-name" >{item.type}</h3>
                  <p className="cv-rio__contactSection--item-value" >{item.value}</p>
                </div>
              ))}
        </>
      );
      ...
      return (
        <>
          <h2 className="cv-rio__personalInfoSection--title" >
            ...
            {
              !previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false && <span className={`cv-rio__section-number progress-indicator ${getProgressColorClass(section.progress)}`}>
                {section.progress}%
                <TbTrashX onClick={(e) => {
                    e.stopPropagation();      // ← evita que se abra el editor
              ...
              {personalInfo.map((item) => (
                <div key={item.id} className="cv-rio__personalInfoSection--item">
                  <h3 className="cv-rio__personalInfoSection--item-name" >{item.name}</h3>
                  <p className="cv-rio__personalInfoSection--item-value" >{item.value}</p>
                </div>
              ))}
        </>
      );
          ...
          <h2 className="cv-rio__skillSection--title" >
            {sectionByName[sectionName]?.title || "Habilidades"}
            {
              ...
              {skillSection.map((skill) => {
                ...
                return (
                  <div key={skill.id} className="cv-rio__skillSection--item">
                    <div className="cv-rio__skillSection--header">
                      <h3 className="cv-rio__skillSection--item-name" >{skill.name}</h3>
                      <p className="cv-rio__skillSection--item-level" >{skill.level}</p>
                    </div>
          ...
          <h2 className="cv-rio__languajeSection--title" >
            {sectionByName[sectionName]?.title || "Idiomas"}
            {
              ...
              {languageSection.map((lang) => {
                ...
                return (
                  <div key={lang.id} className="cv-rio__languajeSection--item">
                    <div className="cv-rio__languajeSection--header">
                      <h3 className="cv-rio__languajeSection--item-name" >{lang.name}</h3>
                      <p className="cv-rio__languajeSection--item-level" >{lang.level}</p>
                    </div>
            ...
            {sectionByName[sectionName]?.title || "Enlaces"}
            {
              !previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false && <span className={`cv-rio__section-number progress-indicator ${getProgressColorClass(section.progress)}`}>
                ...
                {linkSection.map((link) => (
                  <div key={link.id} className="cv-rio__linkSection--item">
            ...
            {sectionByName[sectionName]?.title || "Pasatiempos"}
            {
              ...
              <div className="cv-rio__hobbieSection--list">
                {hobbieSection.map((hobby) => (
                  <span key={hobby.id} className="cv-rio__hobbieSection--item" >
                    {hobby.name}
                  </span>
                ))}
              </div>
    ...
    case "profileSection":
      return (
        <>
          <h2 className="cv-rio__profileSection--title" style={{ color: styles.sectionTitleColor }}>
          ...
          <div className="cv-rio__profileSection--item tiptap" dangerouslySetInnerHTML={{ __html: profileSection }} style={{ color: styles.textColor, opacity: "60%" }}/>
        </>
      );
    ...
    case "experienceSection":
      return (
        <>
          <h2 className="cv-rio__experienceSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Experiencia"}
            {
              ...
              {experienceSection.map((exp) => (
                <div key={exp.id} className="cv-rio__experienceSection--item">
                  <div className="cv-rio__experienceSection--item-head">
                    <h3 className="cv-rio__experienceSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {exp.position},
                      <span className="cv-rio__experienceSection--item-head-employer">{exp.employer}</span>
                    </h3>
                    <p className="cv-rio__experienceSection--item-head-location" style={{ color: styles.textColor, opacity: "60%" }}>{exp.location}</p>
                  </div>
                  <div className="cv-rio__experienceSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>
                  ...
                  <div className="cv-rio__experienceSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: exp.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                </div>
              ))}
        </>
      );
    ...
    case "educationSection":
      return (
        <>
          <h2 className="cv-rio__educationSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Educación"}
            {
              ...
              {educationSection.map((edu) => (
                <div key={edu.id} className="cv-rio__educationSection--item">
                  <div className="cv-rio__educationSection--item-head">
                    <h3 className="cv-rio__educationSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {edu.title},
                      <span className="cv-rio__educationSection--item-head-employer">{edu.institution}</span>
                    </h3>
                    <p className="cv-rio__educationSection--item-head-location" style={{ color: styles.textColor, opacity: "60%" }}>{edu.location}</p>
                  </div>
                  <div className="cv-rio__educationSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>
                  ...
                  {edu.showExtraInfo && edu.description && (
                    <div className="cv-rio__educationSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: edu.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "courseSection":
      return (
        <>
          <h2 className="cv-rio__courseSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Cursos y Certificados"}
            {
              ...
              {courseSection.map((course) => (
                <div key={course.id} className="cv-rio__courseSection--item">
                  <div className="cv-rio__courseSection--item-head">
                    <h3 className="cv-rio__courseSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {course.name},
                      <span className="cv-rio__courseSection--item-head-employer">{course.institution}</span>
                    </h3>
                    {(course.city || course.country) && (
                      <p className="cv-rio__courseSection--item-head-location" style={{ color: styles.textColor, opacity:"60%" }}>
                        {course.city}, {course.country}
                      </p>
                    )}
                  </div>
                  <div className="cv-rio__courseSection--item-date" style={{ color: styles.textColor, opacity:"90%" }}>
                  ...
                  {course.description && (
                    <div className="cv-rio__courseSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: course.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "awardSection":
      return (
        <>
          <h2 className="cv-rio__awardSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Premios"}
            {
              ...
              {awardSection.map((award) => (
                <div key={award.id} className="cv-rio__awardSection--item">
                  <h3 className="cv-rio__awardSection--item-subtitle" style={{ color: styles.itemColor }}>{award.name}</h3>
                  <p className="cv-rio__awardSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>{award.date}</p>
                  {award.description && (
                    <div className="cv-rio__awardSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: award.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "referenceSection":
      return (
        <>
          <h2 className="cv-rio__referenceSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Referencias Laborales"}
            {
              ...
              {referenceSection.map((ref) => (
                <div key={ref.id} className="cv-rio__referenceSection--item">
                  ...
                  <p className="cv-rio__referenceSection--item-phone" style={{ color: styles.textColor, opacity: "60%" }}>{ref.phone}</p>
                  <p className="cv-rio__referenceSection--item-email" style={{ color: styles.textColor, opacity: "60%" }}>{ref.email}</p>
                </div>
              ))}
        </>
      );
    ...
    case "customSection":
      return (
        <>
          <h2 className="cv-rio__customSection--title" style={{ color: styles.sectionTitleColor }}>
              ...
              {customSection.map((item) => (
                <div key={item.id} className="cv-rio__customSection--item tiptap" dangerouslySetInnerHTML={{ __html: item.value }} style={{ color: styles.textColor, opacity: "60%" }}/>
              ))}
        </>
      );
