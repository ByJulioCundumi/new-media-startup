...
import "./cvvienasectionsrender.scss"
...
import { cvVienaDefaults } from "../CvViena";
...
export const CvVienaSectionsRender: React.FC<SectionRenderProps> = ({
  sectionName,
  data,
  sectionByName,
}) => {
...
const getProgressColorClass = (progress: number) => {
  ...
  switch (sectionName) {
    ...
    case "identitySection":
      return (
        <>
          <div className="cv-viena__identitySection--main">
          {!previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false &&
          typeof section?.progress === "number" && (
            <span
              className={`progress-indicator cv-viena__identitySection--progress-indicator ${getProgressColorClass(
                section.progress
              )}`}
            >
              {section.progress}%
              <TbArrowBadgeRight className="cv-viena__arrow" />
            </span>
          )}
          ...
          <div className="cv-viena__identitySection--text">
            <h1
              className="cv-viena__identitySection--title"
            ...
            <p
              className="cv-viena__identitySection--occupation"
        ...
        {allowQrCode && (
          <div className="cv-viena__identitySection--qr-wrapper">
            <QRCodeSVG
              value={qrUrl}
              size={70}
              level="Q"
              ...
              {skillSection.map((skill) => {
                ...
                return (
                  <div key={skill.id} className="cv-viena__skillSection--item">
                    ...
                    {/* Barra de progreso */}
                    <div className="cv-viena__skillSection--progress">
                      <div
                        className="cv-viena__skillSection--progress-bar"
              ...
              {languageSection.map((lang) => {
                ...
                return (
                  <div key={lang.id} className="cv-viena__languajeSection--item">
                    ...
                    {/* Barra de progreso */}
                    <div className="cv-viena__languajeSection--progress">
                      <div
                        className="cv-viena__languajeSection--progress-bar"
                        style={{ width: `${progress}%` }}
                      ></div>
                    </div>
                  </div>
            ...
            {sectionByName[sectionName]?.title || "Enlaces"}
            {
              !previewPopupOpen && sidebarOption === "create" && templatesPopupOpen === false && <span className={`cv-viena__section-number progress-indicator ${getProgressColorClass(section.progress)}`}>
                ...
                {linkSection.map((link) => (
                  <div key={link.id} className="cv-viena__linkSection--item">
    ...
    case "profileSection":
      return (
        <>
          <h2 className="cv-viena__profileSection--title" style={{ color: styles.sectionTitleColor }}>
          ...
          <div className="cv-viena__profileSection--item tiptap" dangerouslySetInnerHTML={{ __html: profileSection }} style={{ color: styles.textColor, opacity: "60%" }}/>
        </>
      );
    ...
    case "experienceSection":
      return (
        <>
          <h2 className="cv-viena__experienceSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Experiencia"}
            {
              ...
              {experienceSection.map((exp) => (
                <div key={exp.id} className="cv-viena__experienceSection--item">
                  <div className="cv-viena__experienceSection--item-head">
                    <h3 className="cv-viena__experienceSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {exp.position},
                      <span className="cv-viena__experienceSection--item-head-employer">{exp.employer}</span>
                    </h3>
                    <p className="cv-viena__experienceSection--item-head-location" style={{ color: styles.textColor, opacity: "60%" }}>{exp.location}</p>
                  </div>
                  <div className="cv-viena__experienceSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>
                    <p className="cv-viena__experienceSection--item-date-start">
                      <span>{exp.startMonth.slice(0, 3)}</span>
                      <span>{exp.startYear}</span>
                    </p>
                    <span>/</span>
                    <p className="cv-viena__experienceSection--item-date-end">
                      <span>{exp.present ? "Actualidad" : `${exp.endMonth.slice(0, 3)} ${exp.endYear}`}</span>
                    </p>
                  </div>
                  <div className="cv-viena__experienceSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: exp.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                </div>
              ))}
        </>
      );
    ...
    case "educationSection":
      return (
        <>
          <h2 className="cv-viena__educationSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Educación"}
            {
              ...
              {educationSection.map((edu) => (
                <div key={edu.id} className="cv-viena__educationSection--item">
                  <div className="cv-viena__educationSection--item-head">
                    <h3 className="cv-viena__educationSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {edu.title},
                      <span className="cv-viena__educationSection--item-head-employer">{edu.institution}</span>
                    </h3>
                    <p className="cv-viena__educationSection--item-head-location" style={{ color: styles.textColor, opacity: "60%" }}>{edu.location}</p>
                  </div>
                  <div className="cv-viena__educationSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>
                    <p className="cv-viena__educationSection--item-date-start">
                      <span>{edu.startMonth.slice(0, 3)}</span>
                      <span>{edu.startYear}</span>
                    </p>
                    <span>/</span>
                    <p className="cv-viena__educationSection--item-date-end">
                      <span>{edu.present ? "Actualidad" : `${edu.endMonth.slice(0, 3)} ${edu.endYear}`}</span>
                    </p>
                  </div>
                  {edu.showExtraInfo && edu.description && (
                    <div className="cv-viena__educationSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: edu.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "courseSection":
      return (
        <>
          <h2 className="cv-viena__courseSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Cursos y Certificados"}
            {
              ...
              {courseSection.map((course) => (
                <div key={course.id} className="cv-viena__courseSection--item">
                  <div className="cv-viena__courseSection--item-head">
                    <h3 className="cv-viena__courseSection--item-head-subtitle" style={{ color: styles.itemColor }}>
                      {course.name},
                      <span className="cv-viena__courseSection--item-head-employer">{course.institution}</span>
                    </h3>
                    {(course.city || course.country) && (
                      <p className="cv-viena__courseSection--item-head-location" style={{ color: styles.textColor, opacity:"60%" }}>
                        {course.city}, {course.country}
                      </p>
                    )}
                  </div>
                  <div className="cv-viena__courseSection--item-date" style={{ color: styles.textColor, opacity:"90%" }}>
                    <p className="cv-viena__courseSection--item-date-start">
                      <span>{course.startDate}</span>
                    </p>
                    <span>/</span>
                    <p className="cv-viena__courseSection--item-date-end">
                      {course.endDate}
                    </p>
                  </div>
                  {course.description && (
                    <div className="cv-viena__courseSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: course.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "awardSection":
      return (
        <>
          <h2 className="cv-viena__awardSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Premios"}
            {
              ...
              {awardSection.map((award) => (
                <div key={award.id} className="cv-viena__awardSection--item">
                  <h3 className="cv-viena__awardSection--item-subtitle" style={{ color: styles.itemColor }}>{award.name}</h3>
                  <p className="cv-viena__awardSection--item-date" style={{ color: styles.textColor, opacity: "90%" }}>{award.date}</p>
                  {award.description && (
                    <div className="cv-viena__awardSection--item-date-description tiptap" dangerouslySetInnerHTML={{ __html: award.description }} style={{ color: styles.textColor, opacity: "60%" }}/>
                  )}
                </div>
              ))}
        </>
    ...
    case "referenceSection":
      return (
        <>
          <h2 className="cv-viena__referenceSection--title" style={{ color: styles.sectionTitleColor }}>
            {sectionByName[sectionName]?.title || "Referencias Laborales"}
            {
              ...
              {referenceSection.map((ref) => (
                <div key={ref.id} className="cv-viena__referenceSection--item">
                  <div className="cv-viena__referenceSection--item-head">
                    <p>
                      <span style={{ color: styles.itemColor }}>{ref.name}</span>,
                      <span style={{ color: styles.itemColor }}>{ref.company}</span>
                    </p>
                  </div>
                  <p className="cv-viena__referenceSection--item-phone" style={{ color: styles.textColor, opacity: "60%" }}>{ref.phone}</p>
                  <p className="cv-viena__referenceSection--item-email" style={{ color: styles.textColor, opacity: "60%" }}>{ref.email}</p>
                </div>
              ))}
        </>
      );
    ...
    case "customSection":
      return (
        <>
          <h2 className="cv-viena__customSection--title" style={{ color: styles.sectionTitleColor }}>
              ...
              {customSection.map((item) => (
                <div key={item.id} className="cv-viena__customSection--item tiptap" dangerouslySetInnerHTML={{ __html: item.value }} style={{ color: styles.textColor, opacity: "60%" }}/>
              ))}
        </>
      );
