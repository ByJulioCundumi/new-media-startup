...
const initialSections: ICvSection[] = [
  { name: "identitySection", title: "Sobre Mi", enabled: true, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "contactSection", title: "Contacto", enabled: true, progress: 0, isOpen: false, orientation: "both" },
  { name: "profileSection", title: "Perfil", enabled: true, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "educationSection", title: "Educación", enabled: true, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "experienceSection", title: "Experiencia", enabled: true, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "skillSection", title: "Habilidades", enabled: true, progress: 0, isOpen: false, orientation: "both" },
  { name: "languageSection", title: "Idiomas", enabled: true, progress: 0, isOpen: false, orientation: "both" },
  { name: "personalInfoSection", title: "Datos Personales", enabled: false, progress: 0, isOpen: false, orientation: "both" },
  { name: "linkSection", title: "Enlaces", enabled: false, progress: 0, isOpen: false, orientation: "both" },
  { name: "courseSection", title: "Cursos y Certificados", enabled: false, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "hobbieSection", title: "Pasatiempos", enabled: false, progress: 0, isOpen: false, orientation: "both" },
  { name: "referenceSection", title: "Referencias Laborales", enabled: false, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "awardSection", title: "Premios", enabled: false, progress: 0, isOpen: false, orientation: "horizontal" },
  { name: "customSection", title: "Campo Personalizado", enabled: false, progress: 0, isOpen: false, orientation: "horizontal" },
];
