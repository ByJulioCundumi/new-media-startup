...
export const Toolbar = ({ commands, editorState }: any) => {
  return (
    <>
      <nav className="toolbar">
        <div className="toolbar-left">
          ...
          <button onClick={commands.toggleH1} className={editorState.isHeading1 ? 'active' : ''}>
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M13 20H11V13H4V20H2V4H4V11H11V4H13V20ZM21.0005 8V20H19.0005L19 10.204L17 10.74V8.67L19.5005 8H21.0005Z"></path>
            </svg>
          </button>

          <button onClick={commands.toggleH2} className={editorState.isHeading2 ? 'active' : ''}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button onClick={commands.toggleH3} className={editorState.isHeading3 ? 'active' : ''}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button onClick={commands.toggleBulletList} className={editorState.isBulletList ? 'active' : ''}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button onClick={commands.toggleAddLink} className={editorState.isLink ? 'active' : ''}>
            <svg viewBox="0 0 24 24" fill="currentColor">
